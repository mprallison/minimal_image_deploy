# Readme
A minimal example of developing a web application docker image locally to be pushed to a repository on GCP artifact registry and deployed as a container on GCP cloud run.  
...
The second half is for building and pushing the image.
...
Authenticate a service account with permissions to access them locally and download account creds.  
